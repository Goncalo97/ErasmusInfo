...
public class MainActivity extends AppCompatActivity { /*implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    */
    ...
    protected void onResume() {
        getSupportLoaderManager().restartLoader(ID_CURSOR_LOADER_ERASMUS_INFO, null, this);
        super.onResume();
    }
    */
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        CursorLoader cursorLoader = new CursorLoader(this, ErasmusInfoContentProvider.PROFILE_ADDRESS, BdTableProfile.ALL_COLUMNS, null, null, BdTableProfile.FIELD_NAME);
