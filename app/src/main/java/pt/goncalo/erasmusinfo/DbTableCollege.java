...
public class DbTableCollege implements BaseColumns {
    ...
    public static final String[] ALL_COLUMNS = new String[] { TABLE_NAME + "." + _ID, TABLE_NAME + "." + FIELD_NAME, FIELD_COUNTRY, FIELD_LOCATION, FIELD_ID_PROFILE, FIELD_NAME_PROFILE };
