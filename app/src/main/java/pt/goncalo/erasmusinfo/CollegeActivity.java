...
public class CollegeActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        recyclerViewCollege = (RecyclerView) findViewById(R.id.recyclerViewCollege);
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        CursorLoader cursorLoader = new CursorLoader(this, ErasmusInfoContentProvider.COLLEGE_ADDRESS, DbTableCollege.ALL_COLUMNS, null, null, DbTableCollege.FIELD_NAME
        );
        return cursorLoader;
    }
